...
#define LEFT_FRONT_PWM 4// Mega output
#define LEFT_REAR_PWM 5
#define RIGHT_FRONT_PWM 6
#define RIGHT_REAR_PWM 7
// From Motor
#define LEFT_FRONT_IN 2  // Mega input
#define RIGHT_FRONT_IN 20 // Mega input
#define LEFT_REAR_IN 3   // Mega input
#define RIGHT_REAR_IN 21  // Mega input
